...
function CopyButton({
  ...
  const [copied, setCopied] = React27__namespace.useState(false);
  const handleCopy = React27__namespace.useCallback(async () => {
    try {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Tooltip, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(
      Button,
      {
        ...
        ...props,
        children: [
          copied ? /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Check, { className: "h-4 w-4 text-green-500" }) : /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Copy, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "sr-only", children: label })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntime.jsx(TooltipContent, { children: /* @__PURE__ */ jsxRuntime.jsx("p", { children: copied ? "Copied!" : label }) })
  ] });
}
function Dialog({
  ...props
...
var InputTags = React27__namespace.forwardRef(
  ({ className, value = [], onChange, ...props }, ref) => {
    const [pendingDataPoint, setPendingDataPoint] = React27__namespace.useState("");
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          value.map((item) => /* @__PURE__ */ jsxRuntime.jsxs(Badge, { variant: "secondary", children: [
            item,
            /* @__PURE__ */ jsxRuntime.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.XIcon, { className: "w-3" })
              }
            )
          ] }, item)),
          /* @__PURE__ */ jsxRuntime.jsx(
